...
def mip(painting, n, m):
    ...
    print "Defining all the valid commands for squares..."
    ...
    print 'Objective : total number of painting commands'
    ...
    print 'Editing the list of the optimal commands...'
    commands = []
    for sq in Sq:
